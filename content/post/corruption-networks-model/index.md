...
{{% callout note %}}
I am pleased to finally publish one of the most important results I obtained during my master's degree. This work, however, would not have been possible without the help of my Ph.D. advisor, Prof. Dr. Haroldo Valentin Ribeiro. I also thank the other coauthors (Bruno R. da Cunha, Matjaž Perc, Quentin S. Hanley and Sebastián Gonçalves) for their collaboration in this work.
{{% /callout %}}

<br>

In our [latest paper](/publication/brazilian-corruption-network), the findings of several universal characteristics of political corruption networks allowed us to propose a model to simulate the growth of corruption networks. Among other results[^1], our research revealed the prominent role of recidivist agents on corruption networks. For instance, we discover that recidivists act as bridges among minor corrupt groups and coordinate peripheral criminals to perform more extensive and often much more harmful corruption processes. 
...
The application below allows you to interact with the network's simulations[^2] and see how they evolve as you add new scandals. To play with it, first click in the **Start new network** button and then add as many scandals as you want using the **Add new scandal** button. Please note that, initially, only complete graphs will appear. After a while[^3], however, the recidivists will show up and they will connect different parts of the network. 
