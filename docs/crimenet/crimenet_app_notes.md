...
about structural patterns — use Ask CRIMENET AI. The AI queries the graph through tools
and synthesizes an answer. As with any LLM response, verify claims against the source
